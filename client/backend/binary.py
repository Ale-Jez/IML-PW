...
# CONFIGURATION
# ============================================================================
MODEL_FILE = "speaker_classifier_backbone.onnx"
BANK_FILE = "speaker_backbone_speaker_bank_single.npy"
...
async def verify_speaker(audio_path):
